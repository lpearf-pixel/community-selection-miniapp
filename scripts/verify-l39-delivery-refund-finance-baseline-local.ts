...
includesAll('scripts/generate-stage-report.ts', ['const l39Manifest', 'L39 delivery refund finance baseline', 'POST /api/after-sales', 'GET /api/admin/finance/refund-ledger/export.csv']);
