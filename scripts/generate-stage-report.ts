...
function hasL45RuntimeMarkers() {
  const required = ['=== L45 manual tax review export scenario ===','l45_finance_total=','l45_concurrent_success_count=2','l45_concurrent_applied_count=1','l45_concurrent_idempotent_count=1','l45_csv_formula_safe=true','L45 manual tax review export runtime assertions passed.'];
...
function stageVerifyChecks(content: string) {
  ...
  if (isL45Stage) {
    return [
      ...
      { command: 'Docker API E2E', result: commandPassed(content, 'Docker API E2E', ['Docker API E2E verification passed.', 'L45 manual tax review export runtime assertions passed.', 'l45_concurrent_success_count=2', 'l45_concurrent_applied_count=1', 'l45_concurrent_idempotent_count=1', 'l45_csv_formula_safe=true'], true) },
