...
export const L45_API_CONTRACT: Record<L45ApiContractEntry['key'], L45ApiContractEntry> = {
  tax_record_list: {
    ...
    runtime_markers_required: ['l45_tax_list_scope_success=true', 'l45_admin_scope_runtime=true', 'l45_tax_list_stable_pagination=true'],
  ...
  mark_paid: {
    ...
    runtime_markers_required: ['l45_mark_paid_success=true', 'l45_mark_paid_conflict_409=true', 'l45_mark_paid_rollback_verified=true', 'l45_mark_paid_not_found_404=true'],
    scenarios: [
      ...
      { type: 'http_status', expected_status: 404, marker: 'l45_mark_paid_not_found_404=true' }
    ]
  }
};
