...
| Mark paid | POST | `/api/admin/withdrawals/:id/mark-paid` | `withdrawal.manage` | data scope | 200 | 400, 401, 403, 404, 409 | `l45_mark_paid_success=true`, `l45_mark_paid_conflict_409=true`, `l45_mark_paid_not_found_404=true` |
...
- Tax record list: `l45_tax_list_scope_success=true`, `l45_admin_scope_runtime=true`, `l45_tax_list_stable_pagination=true`.
...
- Mark paid: `l45_mark_paid_success=true`, `l45_mark_paid_conflict_409=true`, `l45_mark_paid_rollback_verified=true`, `l45_mark_paid_not_found_404=true`.
